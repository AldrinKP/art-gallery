...
const IntroSection = () => {
	return (
		<section className="flex md:flex-row flex-col relative lg:h-[800px]">
			<div className="lg:block hidden z-0 h-full w-[450px] bg-almost-black"></div>
			<div className="z-0 lg:w-[540px] md:w-[437px] w-full lg:h-full md:h-[700px] h-[240px]">
				<picture>
					<source
			...
			<div className="flex lg:flex-row flex-col lg:gap-80 gap-12 md:absolute lg:left-[165px] left-[389px] lg:top-[189px] top-[145px]">
